...
class Cruises {
    ...
    get(path) {
        let promise = new Promise((resolve, reject) => {
            ...
            Wreck.get(`${config.get('/api/host')}${path}`, { json: true }, (err, res, payload) => {
    ...
    getAll() {
        ...
        let promise = new Promise((resolve, reject) => {
            ...
            let data;
            Wreck.get(`${config.get('/api/host')}/cruise-ports`, { json: true }, (err, res, ports) => next(err, { ports }));
            Wreck.get(`${config.get('/api/host')}/cruise-lines`, { json: true }, (err, res, cruiseLines) => next(err, { cruiseLines }));

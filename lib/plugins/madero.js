...
internals.log = (event, options = {}, request = null, callback) => {
    ...
    if (request) {
        ...
        const req = {
            ...
            uaBrowser: `${scoot.family} v${scoot.major}.${scoot.minor}.${scoot.patch}`,
            uaDevice: `${scoot.device.family} v${scoot.device.major}.${scoot.device.minor}.${scoot.device.patch}`,
            uaOS: `${scoot.os.family} v${scoot.os.major}.${scoot.os.minor}.${scoot.os.patch}`
        };
